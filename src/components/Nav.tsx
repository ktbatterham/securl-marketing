    ...
    <header className="glass-heavy sticky top-0 z-50 rounded-none border-b-0" style={{ borderBottom: "1px solid rgba(255,255,255,0.07)" }}>
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <span
              className="block h-[1.5px] w-5 rounded-full bg-zinc-300 transition-all duration-200"
        ...
        >
          {[
            ...
            <a
              ...
              className="rounded-xl px-4 py-3 text-sm font-medium text-zinc-300 transition-colors hover:bg-white/[0.05] hover:text-white"
            >
              {label}
            </a>
          ))}
