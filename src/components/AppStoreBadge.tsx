/* Official-style "Download on the App Store" badge.
   Links to the live SecURL iOS app. Apple-brand black pill with the Apple mark. */
  ...
  return (
    ...
    >
      ...
      <span className="flex flex-col leading-none text-left">
        ...
        <span className="text-lg font-semibold tracking-[-0.01em] text-white">App Store</span>
      </span>
    </a>
  );
}
